...
def test_an_unsupported_element_type_is_refused_rather_than_skipped(tmp_path: Path) -> None:
    """A pyramid (SU2 type 14) is refused. Hexahedra (12) are supported."""
    _write_mesh(tmp_path / "m.su2", ["14 0 1 2 3 4 0"], _CORNERS, {})
    with pytest.raises(ValueError, match="is not a tetrahedron"):
