...
typed into :class:`~aether.flight.simulator.FlightConfiguration`: a length, a
...
does the vehicle glyph in :mod:`aether.viz.scene`. :meth:`to_body_axes`
...
class VehicleMesh:
    ...
    def to_body_axes(self, origin: str = "nose") -> VehicleMesh:
        ...
        glyph in :mod:`aether.viz.scene` both take the nose along +x; meshes
